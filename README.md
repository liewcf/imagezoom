...
- Double-click a useful image that is not inside a link to open the full-page zoom overlay.
- Linked images keep their normal page link click.
- In the overlay, scroll to zoom and drag to pan.
- Press Escape, double-click, or click the dark background to close the overlay.
...
scripts/package-extension.sh
unzip -t dist/image-zoom-v0.1.3.zip
```

## Current Status

Version `0.1.3` is prepared for Chrome Web Store submission.
